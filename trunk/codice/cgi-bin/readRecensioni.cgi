...
<head>
    ...
    <meta name="description" content="recensioni delle avventure testuali con cui si puÃ² giocare nel sito" />
...
#Se il nome della variabile non Ã¨ ID, qualcuno sta cercando di modificare la query string!
...
#il bottone  nascosto se js  abilitato, in teoria
print<<EOF;
